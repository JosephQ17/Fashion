<?php
    ...
    $stmtShoes = $pdo->prepare("SELECT * FROM items WHERE category = 'ws'");
    $stmtShoes->execute();
    $shoesItems = $stmtShoes->fetchAll(PDO::FETCH_ASSOC);

    $stmtBags = $pdo->prepare("SELECT * FROM items WHERE category = 'wb'");
    $stmtBags->execute();
    $bagsItems = $stmtBags->fetchAll(PDO::FETCH_ASSOC);

    $stmtAccessories = $pdo->prepare("SELECT * FROM items WHERE category = 'wa'");
