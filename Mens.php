<?php
    ...
    $stmtShoes = $pdo->prepare("SELECT * FROM items WHERE category = 'ms'");
    $stmtShoes->execute();
    $shoesItems = $stmtShoes->fetchAll(PDO::FETCH_ASSOC);

    $stmtBags = $pdo->prepare("SELECT * FROM items WHERE category = 'mb'");
    $stmtBags->execute();
    $bagsItems = $stmtBags->fetchAll(PDO::FETCH_ASSOC);

    $stmtAccessories = $pdo->prepare("SELECT * FROM items WHERE category = 'ma'");
